     ...
     <table class="menu-container" border="0">
             <tr>
                ...
                <tr class="menu-row" >
                    ...
                    <a href="book.php" class="non-style-link-menu"><div><p class="menu-text">Book</p></div></a>
                    </td>
                </tr>
                <tr class="menu-row" >
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="patient" id="" class="box">
                                    <option value="" disabled selected hidden>Select Patient Name from the list</option>';
                                    
                                    $patientList = $database->query("SELECT * FROM patient ORDER BY pname ASC");
